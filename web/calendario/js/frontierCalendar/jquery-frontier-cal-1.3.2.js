...
(function($) {
	...
	function Calendar() {
		...
		*/
		...
		this.do_init = function(){
			...
			var firstDayWkIndex = (dtFirst.getDay()) ? dtFirst.getDay()-1 : 6;
			// inidex within the week of the last day of the month
			var lastDayWkIndex = (dtLast.getDay()) ? dtLast.getDay()-1 : 6;
		...
		this.renderSingleAgendaItem = function(agi){
			...
			var firstDtIndex = (firstRenderDate.getDay()) ? firstRenderDate.getDay()-1 : 6;
			var lastDtIndex = (lastRenderDate.getDay()) ? lastRenderDate.getDay()-1 : 6;
	...
	// static properties
	Calendar.dayNames = new Array("Lunes","Martes","Miércoles","Jueves","Viernes","Sábado", "Domingo");
	/**
	...
	DateUtil.getNextDay = function(date){
		...
		var dayIndex = (date.getDay()) ? date.getDay()-1 : 6;
